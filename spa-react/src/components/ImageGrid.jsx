...
const ImageGridComponent = ({ imageList, children }) => {
  ...
  if (imageList.error) {
    return (
        <div className="items-center w-full">
          <div className="bg-red-50 px-2 py-3 rounded-lg shadow-sm text-center w-full">
            <p>
              {ti("error")}
            </p>
          </div>
  ...
  if (!imageList.items || imageList.items.length === 0) {
    return (
        <div className="items-center w-full">
          <div className="bg-blue-50 px-2 py-3 rounded-lg shadow-sm text-center w-full">
            <p>
              {ti("no_results")}
            </p>
          </div>
